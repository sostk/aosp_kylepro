...
#ifndef BRCM_OMX_PLUGIN

#define BRCM_OMX_PLUGIN

#include <media/hardware/OMXPluginBase.h>

namespace android {

struct BrcmOMXPlugin : public OMXPluginBase {
    BrcmOMXPlugin();
    virtual ~BrcmOMXPlugin();
...
private:
    ...
    BrcmOMXPlugin(const BrcmOMXPlugin &);
    BrcmOMXPlugin &operator=(const BrcmOMXPlugin &);
};

}  // namespace android

#endif  // BRCM_OMX_PLUGIN
